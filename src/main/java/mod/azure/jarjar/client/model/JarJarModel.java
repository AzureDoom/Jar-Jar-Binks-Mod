package mod.azure.jarjar.client.model;
...
public class JarJarModel<T extends MonsterEntity> extends BipedModel<T> {
	...
	public JarJarModel(float modelSize, boolean smallArmsIn) {
